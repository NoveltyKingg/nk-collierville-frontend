...
const useUploadPromotionalBanner = () => {
  const [{ data, loading }, trigger] = useRequest(
    { method: 'POST', url: '/home/promotions/uploadBanners' },
    { manual: true },
  )
  ...
  const postBanners = async ({ files, formData } = {}) => {
    try {
      ...
      message.success('Promotional images uploaded successfully!')
    } catch (err) {
...
export default useUploadPromotionalBanner
